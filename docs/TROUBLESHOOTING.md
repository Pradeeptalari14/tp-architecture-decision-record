# 🔧 Troubleshooting Guide — Architecture Decision Record (ADR)
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-architecture-decision-record/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/architecture-decision-record/)
