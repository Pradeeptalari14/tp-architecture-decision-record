...
Thank you for your interest in improving the **Architecture Decision Record (ADR)** studio resources! 🎉
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/tp-architecture-decision-record.git
...
Generated configurations come from the **[Architecture Decision Record (ADR) Studio](https://pradeeptalari14.github.io/portfolio/tools/architecture-decision-record/)**.
